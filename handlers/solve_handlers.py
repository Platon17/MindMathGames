...
async def solve(message: types.Message, state: FSMContext):
    kb = [
        [
            ...
            types.KeyboardButton(text=_txt('tickets', message.from_user.id)),
            types.KeyboardButton(text=_txt('cutting', message.from_user.id)),
        ],
        [
            types.KeyboardButton(text=_txt('path', message.from_user.id)),
            types.KeyboardButton(text=_txt('simm', message.from_user.id)),
            types.KeyboardButton(text=_txt('chet', message.from_user.id)),
            types.KeyboardButton(text=_txt('add', message.from_user.id)),
...
async def research(message: types.Message, state: FSMContext):
    kb = [
        [
            types.KeyboardButton(text=_txt('back', message.from_user.id)),
            types.KeyboardButton(text=_txt('home', message.from_user.id)),
            types.KeyboardButton(text=_txt('artur', message.from_user.id)),
            types.KeyboardButton(text=_txt('add', message.from_user.id)),
        ]
    ]
    keyboard = types.ReplyKeyboardMarkup(
...
async def train(message: types.Message, state: FSMContext):
    ...
    async def AI(message: types.Message, state: FSMContext):
        kb = [
            [
                types.KeyboardButton(text=_txt('ChatGPT', message.from_user.id)),
                types.KeyboardButton(text=_txt('CharacterAI', message.from_user.id)),
                types.KeyboardButton(text=_txt('GoogleBard', message.from_user.id)),
                types.KeyboardButton(text=_txt('JanitorAI', message.from_user.id)),
                types.KeyboardButton(text=_txt('PerplexityAI', message.from_user.id)),
            ],
            [
                types.KeyboardButton(text=_txt('Civitai', message.from_user.id)),
                types.KeyboardButton(text=_txt('LeonardoAI', message.from_user.id)),
                types.KeyboardButton(text=_txt('ElevenLabs', message.from_user.id)),
                types.KeyboardButton(text=_txt('CapCut', message.from_user.id)),
                types.KeyboardButton(text=_txt('Cutout.pro', message.from_user.id)),
            ]
        ]
        keyboard = types.ReplyKeyboardMarkup(
            keyboard=kb,
