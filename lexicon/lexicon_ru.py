...
Если вам нужны все возможные варианты, скажите: "Все", а если Вас интересуют любой, попросите: "Только один" или "Любой".',
    ...
    'chosen_cutting':'Это одна из моих любимых задач.',
    'need_cutting':'Назовите несколько чисел, и я расставлю знаки так, чтобы  результат будет последним названным Вами числом.\nПожалуйста, не называйте много чисел (не более 10), а не то я могу сильно задуматься.',
    'wrong_cutting':'Неправильный билет',
